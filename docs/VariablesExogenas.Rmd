...
Resolviendo por $x_t$ obtenemos,
 ...
 \begin{align}
     x_t & = x_{t-1} - (1 - \lambda)x_{t-1} + (1-\lambda)\beta^0 z_t + (1-\lambda)\varepsilon_{t-1} +\upsilon_t \nonumber \\
     & = \beta z_t + \lambda x_{t-1} + u_t \label{map}
 \end{align}
 donde $\beta \equiv (1-\lambda)\beta^0$ y $u_t \equiv (1-\lambda)\varepsilon_{t-1} + \upsilon_t$.
